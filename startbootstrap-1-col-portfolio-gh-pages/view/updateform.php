...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <form action="controllers/update.php" method="post" class="form-horizontal">
                    <div class="form-group">
                        <label for="title">Titre: </label>
                        <input type="text" name="title" id="title" value="<?php echo $video['Titre'] ?>" required="">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="soustitre">Sous-titre: </label>
                        <input type="text" name="soustitle" id="soustitle" value="<?php echo $video['SousTitre'] ?>" required="">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="description">Description: </label><br>
                        <textarea name="description" id="description" rows="4" cols="50"><?php echo $video['Description']; ?></textarea>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="link">Lien de partage: </label>
                        <input type="text" size="60" name="link" id="link" value="<?php echo $video['Lien'] ?>" required="">
                    </div>
                    <br>
                    <div class="form-group">
